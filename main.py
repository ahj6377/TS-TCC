...
for i in range(3):
    for data in ['sleepEDF']:
        ...
        for mode in ['self_supervised']:
            ...
            ######################## Model parameters ########################
            home_dir = os.getcwd()
            parser.add_argument('--experiment_description', default='Exp8', type=str,
                                help='Experiment Description')
            parser.add_argument('--run_description', default=run_num, type=str,
                                help='Experiment Description')
            parser.add_argument('--seed', default=i, type=int,
                                help='seed value')
            parser.add_argument('--training_mode', default=mode, type=str,
                                help='Modes of choice: random_init, supervised, self_supervised, fine_tune, train_linear')
            parser.add_argument('--selected_dataset', default=data, type=str,
            ...
            if training_mode == "fine_tune":
                ...
                load_from = os.path.join(os.path.join('/root/TS-TCC/',logs_save_dir, experiment_description, run_description, f"self_supervised_seed_{SEED}", "saved_models"))
